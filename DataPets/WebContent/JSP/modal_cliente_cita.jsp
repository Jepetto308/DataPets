<%-- 
    Document   : ModalClendario_Cita
    Created on : 27-abr-2017, 20:59:24
    Author     : WILMAR
--%>
    ...
    <body class="fondo-menu">
        ...
        <div class="contenedor-clienteIC">
            <form class="form-usuarios">
                ...
                <input class="filtrar1" minlength="6" maxlength="15" name="identificacion">
                <label class="Lfiltro2IC">Nombre:</label>
                <input class="filtrar2IC" minlength="15" maxlength="45" name="nombre">
...
<!--                <button type="submit" class="btn-exportarUsuario">Exportar <i class="exportar fa fa-clipboard" aria-hidden="true"></i></button>
	...
	<tbody>
        ...
        <tr class="EncabezadoRegistros">
			...
			<td class="cod_Cliente">Codigo Cliente</td>
			<td  class="Nom_ClienteIcitas">Nombre Cliente</td>
               ...
               <td  class="campo-modificar"><i class="modificarICO fa fa-recycle" aria-hidden="true"></i></td>
                ...
                <tr class="listadoUsuario">
                    <td class="listaUsu">1017196647</td>
                    <td class="listaUsu">Wilmar</td>
