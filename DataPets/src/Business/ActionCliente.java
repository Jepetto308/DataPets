...
public class ActionCliente {
	...
	public Map guardarActualizarCliente(clientes oCliente) throws ClassNotFoundException, SQLException{
	...
	public Map consultarCliente(int idCliente,Map parametros) throws ClassNotFoundException, SQLException{
		...
		Conexion oConexion = new Conexion();
		clientes oCliente = oDaoCliente.consularCliente(idCliente, parametros, oConexion);
		datos.put("oCliente", oCliente);
