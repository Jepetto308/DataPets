...
public class ControlAccesoPages extends HttpServlet {
    ...
    public void validatePemisions(HttpServletRequest request, HttpServletResponse response,String codigoRol)
        ...
        if (objSesion == null || objSesion.getAttribute("user") == null) {
            ...
            if (!oUsuario.getCodigoRol().equalsIgnoreCase(codigoRol)) {
