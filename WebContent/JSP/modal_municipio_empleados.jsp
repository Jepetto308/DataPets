<%-- 
    Document   : modal-munucipioUsuario
    Created on : 23-may-2017, 17:30:41
    Author     : WILMAR
--%>
    ...
    <body class="fondo-menu">
        ...
        <div class="contenedor-clienteIC">
            <form class="form-usuarios">
                <div class="titulo-lista"><h2>Lista de Municipios para usuarios</h2></div>
                
                <label class="Lfiltro1-MmC">Codigo Municipio:</label>
                <input class="filtrar1-MmC" maxlength="4" name="codigoMunicipio">
                <label class="Lfiltro2-MmC">Nombre Municipio:</label>
                <input class="filtrar2-MmC" maxlength="25" name="nombreMunicipio">
