<%-- 
    Document   : editar_parametros
    Created on : 24-jul-2017, 19:30:40
    Author     : WILMAR
--%>
   ...
   <title>Data Pets</title>
    ...
    <body class="fondo-menu">
       ...
       <div class="contenedor-menu">
        ...
        <form class="formulario-parametros">
            <div class="titulo-lista"><h2>Parametros</h2></div>
            
           <div class="div-Dpersonales"> 
           
             
               <textarea type="text" class="descripcion-Frol" name="valor"></textarea>
                           <div class="div-IadicionalUsu">  
              <label class="Lform-Fcita">Valor:</label>
